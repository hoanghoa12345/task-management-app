      ...
      {isEditing ? (
        <form action={onSubmit} ref={formRef} className="flex-1 px-0.5">
          <FormInput
            ...
            className="text-sm px-1.75 py-1 h-7 font-medium border-transparent hover:border-input focus:border-input transition truncate bg-transparent focus:bg-white"
          />
        </form>
      ) : (
        <div
